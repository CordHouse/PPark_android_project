...
public final class NavHeaderMainBinding implements ViewBinding {
  ...
  public static NavHeaderMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_login_id;
      TextView tvLoginId = ViewBindings.findChildViewById(rootView, id);
      if (tvLoginId == null) {
        break missingId;
      }

      return new NavHeaderMainBinding((LinearLayout) rootView, imageView, tvLoginId);
    }
